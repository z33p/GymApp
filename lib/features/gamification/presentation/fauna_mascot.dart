...
class FaunaMascot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleStyle = compact ? theme.textTheme.titleMedium : theme.textTheme.headlineSmall;
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(rank.tier.mascot, style: TextStyle(fontSize: compact ? 25 : 48)),
          ),
          const SizedBox(width: 14),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(rank.tier.label, style: titleStyle?.copyWith(fontWeight: FontWeight.bold)),
